 ...
 * @license
 Apache-2.0
 @copyright 2018 ERN-Coda by Simplon
 @model material-design-lite by google
*/
! function() {
    "use strict";
    ...
    function e(e, t) {
        if (e) {
            if (t.element_.classList.contains(t.CssClasses_.JS_RIPPLE_EFFECT)) {
                var s = document.createElement("span");
                s.classList.add(t.CssClasses_.RIPPLE_CONTAINER), s.classList.add(t.CssClasses_.JS_RIPPLE_EFFECT);
                var i = document.createElement("span");
                i.classList.add(t.CssClasses_.RIPPLE), s.appendChild(i), e.appendChild(s)
            }
    ...
    window.MaterialButton = o, o.prototype.Constant_ = {}, o.prototype.CssClasses_ = {
        ...
        RIPPLE_CONTAINER: "button_ripple-container",
        RIPPLE: "ripple"
    ...
    window.MaterialCheckbox = r, r.prototype.Constant_ = {
        ...
        BOX_OUTLINE: "checkbox_box-outline",
        FOCUS_HELPER: "checkbox_focus-helper",
        TICK_OUTLINE: "checkbox_tick-outline",
        RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "checkbox_ripple-container",
    ...
    window.MaterialIconToggle = _, _.prototype.Constant_ = {
        ...
        INPUT: "icon-toggle_input",
        JS_RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "icon-toggle_ripple-container",
        RIPPLE_CENTER: "ripple--center",
        RIPPLE: "ripple",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
    ...
    window.MaterialMenu = d, d.prototype.Constant_ = {
        ...
        OUTLINE: "menu_outline",
        ITEM: "menu_item",
        ITEM_RIPPLE_CONTAINER: "menu_item-ripple-container",
        RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        RIPPLE: "ripple",
        IS_UPGRADED: "is-upgraded",
    ...
    window.MaterialProgress = h, h.prototype.Constant_ = {}, h.prototype.CssClasses_ = {
        INDETERMINATE_CLASS: "progress_indeterminate"
    ...
    window.MaterialRadio = c, c.prototype.Constant_ = {
        ...
        IS_UPGRADED: "is-upgraded",
        JS_RADIO: "js-radio",
        RADIO_BTN: "radio_button",
        RADIO_OUTER_CIRCLE: "radio_outer-circle",
        RADIO_INNER_CIRCLE: "radio_inner-circle",
        RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "radio_ripple-container",
        RIPPLE_CENTER: "ripple--center",
        RIPPLE: "ripple"
    ...
    window.MaterialSlider = p, p.prototype.Constant_ = {}, p.prototype.CssClasses_ = {
        IE_CONTAINER: "slider_ie-container",
        SLIDER_CONTAINER: "slider_container",
        BACKGROUND_FLEX: "slider_background-flex",
        BACKGROUND_LOWER: "slider_background-lower",
        BACKGROUND_UPPER: "slider_background-upper",
    ...
    window.MaterialSpinner = u, u.prototype.Constant_ = {
        ...
        SPINNER_LAYER: "spinner_layer",
        SPINNER_CIRCLE_CLIPPER: "spinner_circle-clipper",
        SPINNER_CIRCLE: "spinner_circle",
        SPINNER_GAP_PATCH: "spinner_gap-patch",
        SPINNER_LEFT: "spinner_left",
        SPINNER_RIGHT: "spinner_right"
    }, u.prototype.createLayer = function(e) {
        var t = document.createElement("div");
        t.classList.add(this.CssClasses_.SPINNER_LAYER), t.classList.add(this.CssClasses_.SPINNER_LAYER + "-" + e);
        var s = document.createElement("div");
        s.classList.add(this.CssClasses_.SPINNER_CIRCLE_CLIPPER), s.classList.add(this.CssClasses_.SPINNER_LEFT);
        var i = document.createElement("div");
        i.classList.add(this.CssClasses_.SPINNER_GAP_PATCH);
        var n = document.createElement("div");
        n.classList.add(this.CssClasses_.SPINNER_CIRCLE_CLIPPER), n.classList.add(this.CssClasses_.SPINNER_RIGHT);
        for (var a = [s, i, n], l = 0; l < a.length; l++) {
            var o = document.createElement("div");
            o.classList.add(this.CssClasses_.SPINNER_CIRCLE), a[l].appendChild(o)
        }
        ...
        if (this.element_) {
            for (var e = 1; e <= this.Constant_.SPINNER_LAYER_COUNT; e++) this.createLayer(e);
    ...
    window.MaterialSwitch = E, E.prototype.Constant_ = {
        ...
        TRACK: "switch_track",
        THUMB: "switch_thumb",
        FOCUS_HELPER: "switch_focus-helper",
        RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        RIPPLE_CONTAINER: "switch_ripple-container",
        RIPPLE_CENTER: "ripple--center",
        RIPPLE: "ripple",
        IS_FOCUSED: "is-focused",
        IS_DISABLED: "is-disabled",
    ...
    window.MaterialTabs = m, m.prototype.Constant_ = {}, m.prototype.CssClasses_ = {
        TAB_CLASS: "tabs_tab",
        PANEL_CLASS: "tabs_panel",
        ACTIVE_CLASS: "is-active",
        UPGRADED_CLASS: "is-upgraded",
        JS_RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_CONTAINER: "tabs_ripple-container",
        RIPPLE: "ripple",
        JS_RIPPLE_EFFECT_IGNORE_EVENTS: "js-ripple-effect--ignore-events"
    }, m.prototype.initTabs_ = function() {
        this.element_.classList.contains(this.CssClasses_.JS_RIPPLE_EFFECT) && this.element_.classList.add(this.CssClasses_.JS_RIPPLE_EFFECT_IGNORE_EVENTS), this.tabs_ = this.element_.querySelectorAll("." + this.CssClasses_.TAB_CLASS), this.panels_ = this.element_.querySelectorAll("." + this.CssClasses_.PANEL_CLASS);
    ...
    window.MaterialLayout = f, f.prototype.Constant_ = {
        ...
        DRAWER: "drawer",
        CONTENT: "content",
        DRAWER_BTN: "drawer-button",
        ICON: "material-icons",
        JS_RIPPLE_EFFECT: "js-ripple-effect",
        RIPPLE_CONTAINER: "tab-ripple-container",
        RIPPLE: "ripple",
        RIPPLE_IGNORE_EVENTS: "js-ripple-effect--ignore-events",
        HEADER_SEAMED: "header--seamed",
        HEADER_WATERFALL: "header--waterfall",
        HEADER_SCROLL: "header--scroll",
        FIXED_HEADER: "layout--fixed-header",
        OBFUSCATOR: "obfuscator",
        TAB_BAR: "tab-bar",
        TAB_CONTAINER: "tab-bar-container",
        TAB: "tab",
        TAB_BAR_BUTTON: "tab-bar-button",
        TAB_BAR_LEFT_BUTTON: "tab-bar-left-button",
        TAB_BAR_RIGHT_BUTTON: "tab-bar-right-button",
        TAB_MANUAL_SWITCH: "tab-manual-switch",
        PANEL: "tab-panel",
    ...
    window.MaterialDataTable = b, b.prototype.Constant_ = {}, b.prototype.CssClasses_ = {
        ...
        SELECT_ELEMENT: "data-table_select",
        ...
        return a.type = "checkbox", a.classList.add("checkbox_input"), e ? (a.checked = e.classList.contains(this.CssClasses_.IS_SELECTED), a.addEventListener("change", this.selectRow_(a, e))) : t && a.addEventListener("change", this.selectRow_(a, null, t)), i.appendChild(a), s.upgradeElement(i, "MaterialCheckbox"), i

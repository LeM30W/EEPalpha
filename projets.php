...
<body>
  <div class="layout js-layout fixed-header">
    <header class="header">
      <div class="header_row flexcontainer logodesktop">
        <div class="flextitle">
          <a href="#"> <img src="./img/logo_lit.png" alt="little logo" class="logolit">
          <span class="title">E.E.P. by <img src="./img/logo.png" alt="logo" class="logo"> &raquo; Accueil</span>
          <span class="titlemobile">E.E.P. &raquo; Accueil</span></a>
        </div>
        <div class="flexbox">
          <!-- Zone de recherche topmenu -->
          <form action="#" class="hiddendesktop">
            <div class="textfield js-textfield textfield--expandable">
              <label class="button js-button button--icon" for="sample6">
        ...
        <div class="flexbox hiddendesktop rightpad">
          ...
          <ul class="menu menu--bottom-right js-menu js-ripple-effect" for="demo-menu-lower-right">
            <li class="menu_item">Connexion</li>
    ...
    <div class="drawer">
      <span class="titlemenu">EEP - SIMPLON </span>
        <?php include 'mvc/nav.php' ?>
    </div>
    <!--Contenu de la page-->
    <main class="content">
      <?php include 'mvc/content_projets.php' ?>
    </main>
  </div>
